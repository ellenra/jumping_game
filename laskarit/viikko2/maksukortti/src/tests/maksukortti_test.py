...
class TestMaksukortti(unittest.TestCase):
    ...
    def kortille_ei_voi_ladata_negatiivista_summaa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa") 
        
    def test_kortilla_voi_ostaa_edullisen_lounaan_jos_rahaa_vain_sen_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_kortilla_voi_ostaa_maukkaan_lounaan_jos_rahaa_vain_sen_verran(self):
